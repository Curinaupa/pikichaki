 ...
 * Open project called  TestException.
 ...
 Try compiling it without an exception specification to see what the compiler says. Add the appropriate
 exception specification (throws). Try out your class and its exception inside a try-catch clause.
 Execute the program.
