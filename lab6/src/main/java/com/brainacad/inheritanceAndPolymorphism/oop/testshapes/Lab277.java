 ...
 * Add to project  “MyShapes” a new class “Circle” which is a subclass of Shape.
 ...
 In class Circle override the toString() method. It must return string which contain name
 of shape, color and radius of circle. Example:
 “This is Circle, color: GREEN, radius=22”
 Add to class Circle constructor with color and radius arguments.

 Then add to class Main code to create one Circle object and print it name color, and radius
