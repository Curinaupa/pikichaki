 ...
 * Add to project  “MyShapes” a new class “Rectangle” which is a subclass of Shape.
 ...
 In class Rectangle override the toString() method. It must return string which contain name of shape,
 color and rectangle width and height. Example:
 “This is Rectangle, color: RED, width=11, height=22”
 Add to class Rectangle constructor with color , width and height arguments.

 Then add to class MainLab141 code to create one Rectangle object and print it name, color, width and height to console.
