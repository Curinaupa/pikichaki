 ...
 * characteristics of each shape on console.
 ...
 …
 5.	Add code to calculate total area of all shape types. Define “sumArea” (of double type) local variable and use
 it in loop to sum total area for all shapes.
 6.	Add code to sum total area for each shape types. Define “sumRectArea”, “sumTriangleArea”, “sumCircleArea”
 (of double type) local variables and use it in loop to sum total area for each shape type. You should use instanceof keyword
 for determining, total area for each of shape types (Rectangle, Circle, Triangle) and print it to console.
